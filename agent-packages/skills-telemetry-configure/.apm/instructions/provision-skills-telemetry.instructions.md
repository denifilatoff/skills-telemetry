---
description: Trigger for the provision-skills-telemetry skill — set up, repair, or verify skill-usage telemetry on a machine. Fires after installing the qubership-skills-telemetry package, when skill events are not reaching the collector, or when the user asks to provision, check, or fix telemetry.
applyTo: "**"
---
...
- just installed the `qubership-skills-telemetry` package, or finished `apm install`;
